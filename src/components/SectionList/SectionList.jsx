...
const SectionList = () => {
  const { selectedSection, selectSection, isDrawerOpen } = useApp();
  ...
  return (
    <div className={`${styles.sectionList} ${isDrawerOpen ? styles.withSidebar : ''}`}>
      ...
      <div className={styles.socialIcons}>
        ...
        <svg className={styles.socialIcon} viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725zm-11.901-11.287l11.901 9.638 11.901-9.638h-23.802z"/>
        </svg>
        <svg className={styles.socialIcon} viewBox="0 0 24 24" fill="currentColor">
